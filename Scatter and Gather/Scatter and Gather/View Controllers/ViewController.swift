...
class ViewController: UIViewController {
    ...
    @IBOutlet var letterLLabel: UILabel!
    @IBOutlet var letterALabel: UILabel!
    @IBOutlet var letterMLabel: UILabel!
    @IBOutlet var letterBLabel: UILabel!
    @IBOutlet var letterDLabel: UILabel!
    @IBOutlet var lastALabel: UILabel!
